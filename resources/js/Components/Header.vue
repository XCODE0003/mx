        ...
        <div class="container">
            <div :class="{ 'autharization': user != null }" class="header_items">
                <div class="header_item">
                    <Link href="/" class="header_item_logo"><img src="/assets/img/logo.svg" style="width: 100px;" alt=""></Link>
                </div>
                <div class="header_item header_item--center">
                    <ul class="header_item_navs">
                        <li class="header_item_nav"><Link href="/" :class="{ 'active': isActive('/') && page.url === '/' }">Главная</Link></li>
                        <li class="header_item_nav"><Link href="/profile/constructor" :class="{ 'active': isActive('/profile') }">Конструктор вариантов</Link></li>
                        <li class="header_item_nav"><Link href="/reviews" :class="{ 'active': isActive('/reviews') }">Отзывы</Link></li>
                        <li class="header_item_nav"><Link href="/news" :class="{ 'active': isActive('/news') }">Новости</Link></li>
                        <li class="header_item_nav"><Link href="/faq" :class="{ 'active': isActive('/faq') }">FAQ</Link></li>
                        <li class="header_item_nav"><Link href="/banks" :class="{ 'active': isActive('/banks') }">Банк заданий</Link></li>
                    </ul>
                </div>
                <div class="header_item">
                    <div  class="header_item_buttons">
                        <Link href="/signup"><button class="header_button">Регистрация</button></Link>
                        <Link href="/login"><button class="header_button">Вход</button></Link>
                    </div>
                        ...
                        <div class="header_mobile_menu">
                            ...
                            <div class="header_mobile_menu_rect">
                                <div class="header_mobile_menu_rect_content">
                                    ...
                                    <ul class="header_item_navs">
                                        <li class="header_item_nav"><Link href="/" @click="closeMobileMenu">Главная</Link></li>
                                        <li class="header_item_nav"><Link href="/profile/constructor" @click="closeMobileMenu">Конструктор вариантов</Link></li>
                                        <li class="header_item_nav"><Link href="/reviews" @click="closeMobileMenu">Отзывы</Link></li>
                                        <li class="header_item_nav"><Link href="/news" @click="closeMobileMenu">Новости</Link></li>
                                        <li class="header_item_nav"><Link href="/faq" @click="closeMobileMenu">FAQ</Link></li>
                                        <li class="header_item_nav"><Link href="/banks" @click="closeMobileMenu">Банк заданий</Link></li>
                                    </ul>
